...
use xenolith::dtd::{AttDef, AttType, ContentParticle, ContentSpec, DefaultDecl, ExternalId, GeneralEntity, Occurs};
use xenolith::dtd::{Dtd, parse_subset};
...
fn every_kind_of_declaration_can_be_walked() {
  ...
  let names = |ids: Vec<xenolith::name::NameId>| {
