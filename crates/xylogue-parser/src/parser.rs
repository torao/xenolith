...
///
/// ```
/// use xylogue_parser::{EventKind, Parser, Progress};
///
...
impl Parser {
  ...
  ///
  /// ```
  /// use xylogue_parser::{CharStream, Entity, Limits, Parser};
  ///
  ...
  ///
  /// ```
  /// use xylogue_parser::{Parser, ParserConfig};
  ///
  /// let mut parser = Parser::new();
...
mod tests {
  ...
  /// the remedy and not merely for the complaint. See the guidance in `xylogue_core::error`.
  #[test]
