//! The XPath data model over one or more [`xylogue_dom`] documents.
//!
...
use xylogue_core::name::{NameId, XML_NS_URI, XMLNS_NS_URI};
...
impl Documents {
  ...
  /// use xylogue_xdm::{Documents, DomModel, Model};
  ///
