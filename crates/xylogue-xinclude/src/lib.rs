//! XInclude 1.0 processing for xylogue.
//!
//! XInclude is a post-processing pass over a [DOM](xylogue_dom): it finds `xi:include`
...
//! [builder](xylogue_dom::build) recorded — `href` resolves against the base URI in effect
...
//! XInclude elements. This crate does not validate; run `xylogue-validate` over the result.
//!
//! # Examples
//!
//! ```
