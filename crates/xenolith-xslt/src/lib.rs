...
//!
//! Extension functions are registered with [`Functions`](xenolith_xpath::Functions) and handed
//! to [`Transform::run_with`]; `xenolith-exslt` is built on nothing else. XSLT's own functions
