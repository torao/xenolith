//! xylogue: XML processing and XSLT 1.0 in Rust.
//!
...
//! and gathered here under one name and one dependency. Depend on `xylogue` and reach the
...
//! |---|---|---|
//! | [XML 1.0 (Fifth Edition)] | REC 2008-11-26 | [`parser`], [`validate`], [`serialize`], [`core`](xylogue_core) |
...
//! | [RFC 3986] | STD 66, 2005-01 | [`core`](xylogue_core) |
//!
