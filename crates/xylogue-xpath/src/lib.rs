//! XPath 1.0 for xylogue: reading an expression into a tree.
//!
...
//! [data model](xylogue_xdm). The result is a [`Value`] — a node-set, a boolean, a number or a
...
/// use xylogue_dom::build;
/// use xylogue_xdm::DomModel;
/// use xylogue_xpath::{Namespaces, Value, Variables, evaluate_with, parse};
///
