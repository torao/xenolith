...
///
/// ```
/// use xylogue_core::chars::is_char;
///
/// assert!(is_char('\t'));
...
///
/// ```
/// use xylogue_core::chars::is_char_code;
///
...
///
/// ```
/// use xylogue_core::chars::is_name;
///
/// assert!(is_name("item"));
...
///
/// ```
/// use xylogue_core::chars::is_ncname;
///
...
///
/// ```
/// use xylogue_core::chars::is_enc_name;
///
...
///
/// ```
/// use xylogue_core::chars::split_qname;
///
