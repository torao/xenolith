...
impl UriReference {
  ...
  /// let resolved = |r: &str| -> Result<String, xylogue_core::Error> {
  ...
  ///
  /// let base = UriReference::parse("http://example.org/a/b/c.xml")?;
  /// let relative = |t: &str| -> Result<String, xylogue_core::Error> {
...
///
/// ```
/// use xylogue_core::uri::escape_uri;
///
