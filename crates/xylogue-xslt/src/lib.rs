...
//!
//! Extension functions are registered with [`Functions`](xylogue_xpath::Functions) and handed
//! to [`Transform::run_with`]; `xylogue-exslt` is built on nothing else. XSLT's own functions
