//! EXSLT extension functions for xenolith's XSLT 1.0 engine.
//!
...
//! the function, and the `xenolith` crate's behaviour report prints it.
//!
...
use xenolith_xpath::Functions;
use xenolith_xslt::{DocumentSource, NoDocuments};
...
/// that model cannot read — `xenolith_xslt::TreeSpace` is the usual one.
///
/// # Examples
///
...
/// let modules = xenolith_exslt::modules();
