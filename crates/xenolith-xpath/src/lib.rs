//! XPath 1.0 for xenolith: reading an expression into a tree.
//!
...
//! [data model](xenolith_xdm). The result is a [`Value`] — a node-set, a boolean, a number or a
...
//! | `XPathExpressionException` | [`Error::XPath`](xenolith_core::Error::XPath) |
//!
...
/// # Errors
///
/// Returns [`Error::XPath`](xenolith_core::Error::XPath) if the expression cannot be
...
/// # Errors
///
/// Returns [`Error::XPath`](xenolith_core::Error::XPath) if the expression asks for
