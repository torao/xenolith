...
//!
//! This drives the [parser](xylogue_parser) and turns its event stream into a tree: a start
...
use xylogue_parser::dtd::AttType;
use xylogue_parser::{EventKind, Parser, Reader};
